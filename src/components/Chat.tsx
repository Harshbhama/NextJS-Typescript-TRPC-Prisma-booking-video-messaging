...
import { checkForCurrentChatFriend } from "@/lib/utils";
...
const ChatWrapper = ({params}: any) => {
  ...
  return (
    <div className="flex-1 p:2 sm:p-6 justify-between flex flex-col min-h-[500px]">
      <div className="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
        <div className="relative flex items-center space-x-4">
          <div className="relative">
            ...
            <Image
              src={chatUserDetails?.profilePic}
              alt=""
          ...
          <div className="flex flex-col leading-tight">
            <div className="text-2xl mt-1 flex items-center">
              {chatUserDetails?.firstName && (
                <span className="text-gray-700 mr-3 capitalize">
                  {chatUserDetails?.firstName + " " + chatUserDetails?.lastName}
                </span>
              )}
            </div>
            {chatUserDetails?.email && (
      ...
      >
        {receivedMsg?.map((msg: any, index: number) => {
          return (
            <div className="chat-message">
              <div className={`flex items-end ${msg?.userId === cUserDetails?.id ? '' : 'justify-end'}`}>
                ...
                <Image
                  src={msg?.userId === cUserDetails?.id ? cUserDetails?.profilePic : chatUserDetails?.profilePic}
                  alt="My profile"
